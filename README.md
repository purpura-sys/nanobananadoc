...
**Для работы сервиса потребует хороший VPN. Желательно не бесплатный.*

## Оглавление

- [1. Создание проектов](#1-создание-проектов)
- [2. Написание промпта](#2-написание-промпта)
- [3. Работа с NanoBanana](#3-работа-с-nanobanana)
- [4. Скачивание готовых изображений](#4-скачивание-готовых-изображений)
- [5. Дополнительная организация рабочего пространства](#5-дополнительная-организация-рабочего-пространства)
- [6. Работа с внутренним агентом NanoBanana](#6-работа-с-внутренним-агентом-nanobanana)
- [7. Tools. Создание инструментов](#7-tools-создание-инструментов)
- [8. Ошибки соединения](#8-ошибки-соединения)
- [Обновления и Дополнительные ресурсы](#обновления-и-дополнительные-ресурсы)
...
* Если имеется готовый промпт – переходите к пункту **[3. Работа с NanoBanana](#3-работа-с-nanobanana)**
...
* Написанный детальный промпт с описанием внешнего вида модели из пункта **[2. Написание промпта](#2-написание-промпта)** поместите в чатбокс NanoBanana
...
* Изображения скачиваются с коротким описанием промпта в имени файла. Например: Ultra-realistic_high-end_men's_lifestyle_fashion_202606081301.jpeg Для удобства можно переименовать и поставить артикул товара в начало имени. Подробное описание, как переименовать несколько файлов одновременно описано далее в пункте **[5. Дополнительная организация рабочего пространства](#5-дополнительная-организация-рабочего-пространства)** разделе **Переименовывание файлов*
...
## 6. Работа с внутренним агентом NanoBanana
---

Внутренний агент в основном нужен для автоматизации задач и редактирования готового материала. Агент понимает контекст проекта. Может быть использован для генерации идей, сохраняя при этом контроль над процессом.
Остальные задачи по редактированию и созданию изображений можно придумать самим.
* Автоматизация: Агент может анализировать весь проект, распознавать входные данные (изображения, подсказки пользователя или активность в облачном хранилище) и автоматически выполнять многоэтапные редактирования по запросу.
* Редактирование в диалоговом режиме: Вместо ручной корректировки агент может принимать команды для замены фона, изменения внешности и модификации стилей.
* Инструкции: Агенту можно сохранить несколько готовых инструкций по созданию изображений, в виде нескольких промптов например, и написать команду к действию. Инструкции можно использовать для применения определенных стилей, ракурсов или творческих предпочтений.

Включить внутреннего агента можно нажав на кнопку Agent. Правее находится меню для создания инструкций.
Там же и кнопка перемещения окна в правую часть экрана для удобства пользования.
...
При включенных инструкциях агенту можно дать задание работать по ним с заранее загруженными референсами, как было описано ранее в пункте **[3. Работа с NanoBanana](#3-работа-с-nanobanana)**
...
## 7. Tools. Создание инструментов
---

**Tools относительно недавний функционал Google Flow. Вы можете создавать, модифицировать и делиться инструментами, которые легко использовать в своих проектах. Всё это на естественном языке. Получить доступ к библиотеке инструментов можно в левой боковой панели, чтобы изучить готовые инструменты или создать свои собственные.*

Инструменты можно использовать для рутинных задач. Например для добавления текста на изображение или редактирования видео если не хотите или не умеете пользоваться более профессиональным функционалом в Photoshop, Premier или иных редакторах.

> Каждый инструмент это как отдельное приложение, которое создаётся по вашему промпту. Нужно описать задачу которое оно должно выполнять и как должно выглядить для удобства использования.

<img width="1559" height="909" alt="8 5  - Tools " src="https://github.com/user-attachments/assets/c2439f43-1fe9-42a8-9cc3-f294af2eed57" />

<img width="1569" height="923" alt="8 6  - Create tool" src="https://github.com/user-attachments/assets/06b2242b-0c07-47c5-a413-0a547cee7a0c" />

<img width="1559" height="923" alt="8 7  - Tool prompting" src="https://github.com/user-attachments/assets/53fec130-49a9-4428-957c-54df337d9a6e" />
