...
- [7. Ошибки соединения](#7-ошибки-соединения)
...
Внутренний агент в основном нужен для автоматизации задач и редактирования готового материала.
...
* Инструкции: Агенту можно сохранить несколько готовых инструкций по созданию изображений, в виде нескольких промптов например, и написать команду к действию.

Включить внутреннего агента можно нажав на кнопку Agent. Правее находится меню для создания инструкций.
Для удобства там же и кнопка перемещения окна в правую часть экрана для удобства пользования.
